...
public class ElevatorSubsystem extends Subsystem {
    ...
    private static final double K_P = 0.2000;
    private static final double K_I = 0.0001;
    private static final double K_D = 0.0000;
    private static final double K_F = 0.0000;
    ...
    public ElevatorSubsystem() {
        ...
        this.talons[0].configSetParameter(ParamEnum.eClearPositionOnLimitR, 1, 0, 0, RobotMap.TALON_COMMAND_TIMEOUT);
